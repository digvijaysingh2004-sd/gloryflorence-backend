...
{
    /// <inheritdoc />
    public partial class AddProfilePictureToPatient : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ALTER TABLE ""Patients"" ADD COLUMN IF NOT EXISTS ""ProfilePictureUrl"" character varying(500) NULL;
